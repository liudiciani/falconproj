...
var team = [
	...
	member('araleigh', 'Andrew', 'Raleigh', 'junior'),
	member('liudiciani', 'Lisa', 'Iudiciani', 'junior'),
	member('akaplowitz', 'Aaron', 'Kaplowitz', 'junior'),
	member('jkoester', 'Jared', 'Koester', 'junior'), //check
	member('bdanzig', 'Ben', 'Danzig', 'junior'),
	member('tzentz', 'Tyler', 'Zentz', 'junior')
];
